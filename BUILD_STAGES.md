...
3. Compare against the mockup:
```
View docs/design/<name>.png and compare it to the running page at http://localhost:5173/<route>. List visual differences, most important first. Do not fix them yet.
```
